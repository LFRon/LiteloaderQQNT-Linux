...
function get_qqnt_appimage_url() {
    if [ "$os_arch" == "x86_64" ]; then
        appimage_url="https://dldir1v6.qq.com/qqfile/qq/QQNT/Linux/QQ_3.2.26_260311_x86_64_01.AppImage";
    elif [ "$os_arch" == "arm64" ]; then
        appimage_url="https://dldir1v6.qq.com/qqfile/qq/QQNT/Linux/QQ_3.2.26_260311_arm64_01.AppImage";
    fi
    echo "$appimage_url"
}
